    ...
    <Row>
      <Col md="8">
        <h2 data-cy="tagDetailsHeading">
          <Translate contentKey="gallerySystemApp.tag.detail.title">Tag</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gallerySystemApp.tag.albums">Albums</Translate>
          </dt>
          <dd>
            {tagEntity.albums
              ? tagEntity.albums.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {tagEntity.albums && i === tagEntity.albums.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
